...
namespace ViewModell
{
    ...
    {
        private static bool fornated = false;
        ...
        public BaseDb()
        {//C:\Users\Student.HP-6KHJCV2\source\repos\Test\bin\Debug\net8.0
         //    if (!BaseDb.fornated)
         //    { 
         ...
         //        BaseDb.connectionString += ThisPath + @"\ViewModell\Library.accdb";
         //        BaseDb.fornated = true;
         //    }
